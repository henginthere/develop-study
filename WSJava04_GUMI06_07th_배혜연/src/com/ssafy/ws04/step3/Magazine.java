...
public class Magazine extends Book{
	...
	Magazine(String isbn, String title, String author, String publisher, int price, String desc, int quantity, int year, int month ){
	...
	"    | "+super.quantity + "  |  "+ this.year+"   | "+this.month;
