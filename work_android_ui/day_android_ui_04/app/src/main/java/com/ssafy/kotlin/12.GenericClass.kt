...
//FoodTruck에 Pizza를 담아주세요. Container 인터페이스 활용
class Pizza{

}

class FoodTruck : Container<Pizza>{
    private val pizzas: MutableList<Pizza> = arrayListOf()
    override fun put(item: Pizza) {
        pizzas.add(item)
    }

    override fun take(index: Int): Pizza {
