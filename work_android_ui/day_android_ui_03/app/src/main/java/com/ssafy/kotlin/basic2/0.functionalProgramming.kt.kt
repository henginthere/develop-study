...
val sum0:(Int, Int) -> Int = { x1: Int, x2: Int -> x1 + x2 } //익명함수
...
//문제1.
val answer = {value: Int ->
    println("value $value")
    value.toString()+"원"
}

//문제2.
val answer2 = { parent: String, position: Int, id:Int ->
    println("파라미터 값: $parent, $position, $id")
    position
}
