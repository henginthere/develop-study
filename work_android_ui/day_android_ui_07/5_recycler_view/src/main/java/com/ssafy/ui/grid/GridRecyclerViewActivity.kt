...
class GridRecyclerViewActivity : AppCompatActivity() {
    ...
    private lateinit var gridAdapter: GridRecyclerViewAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gridAdapter.onItemClickListener = object: GridRecyclerViewAdapter.OnItemClickListener {
            override fun onClick(view: View, position: Int) {
                Toast.makeText(this@GridRecyclerViewActivity,
                    "Activity에서 설정한 리스너 : $position", Toast.LENGTH_SHORT).show()
            }
        }
