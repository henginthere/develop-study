...
class StoreMenuDetailActivity : AppCompatActivity() {
    ...
    private lateinit var service: ReceiptService
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        service = ApplicationClass.retrofit.create(ReceiptService::class.java)
            ...
            builder
                ...
                .setPositiveButton("예",
                    DialogInterface.OnClickListener { dialog, id ->
                        ...
                        val orderMenu = ReceiptDTO(name, simpleDataFormat, price)
                        Log.d(TAG, "onCreate: $name $simpleDataFormat")


                        service.insertReceipt(orderMenu).enqueue(object : Callback<Unit> {
