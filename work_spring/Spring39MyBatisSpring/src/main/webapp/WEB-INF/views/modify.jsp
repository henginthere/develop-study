	...
	<div class="container">
		...
		<form method="post" action="${ root }/modify">
			...
			<div class="form-group">
				...
				<input type="text" id="title" name="title" class="form-control-sm" value="${board.title}">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" id="writer" name="writer" class="form-control-sm" value="${ board.writer }">
			</div>
